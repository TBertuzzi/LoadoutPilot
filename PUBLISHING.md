# Publishing Loadout Pilot 2.1.0

## Before publishing

1. Install the Test ZIP into `_retail_/Interface/AddOns/`.
2. Confirm the main 2.0 sidebar UI opens without Lua errors.
3. Verify the 2.1.0 Lair regression: enter **The Tidebound Grotto** and confirm the HUD/context uses **Raid**, not Delve. Leave the Lair and confirm World is restored.
...
Upload `LoadoutPilot-v2.1.0-CurseForge.zip`.
...
`Loadout Pilot 2.1.0 - Lair context hotfix`

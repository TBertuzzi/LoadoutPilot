...
local enUS = {
    ...
    DUNGEON_OVERRIDES_DESCRIPTION = "Override specialization, talents, or equipment for individual dungeons. Unconfigured fields inherit the normal Dungeon or Mythic+ mapping.",
    ...
    DUNGEON_OVERRIDES_EMPTY = "Enter a dungeon or use a Mythic+ dungeon from the list to create an override.",
    DUNGEON_FALLBACK = "Fallback: %s default mapping",
...
local ptBR = {
    ...
    DUNGEON_OVERRIDES_DESCRIPTION = "Defina especialização, talentos ou equipamento específicos para cada masmorra. Campos não configurados herdam o mapeamento padrão de Masmorra ou Mítica+.",
    ...
    DUNGEON_OVERRIDES_EMPTY = "Entre em uma masmorra ou escolha uma Mítica+ da lista para criar um override.",
    DUNGEON_FALLBACK = "Fallback: mapeamento padrão de %s",
